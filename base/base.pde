...
PImage downl; // person1
PImage downr;// person1
PImage down;
PImage upl;
PImage upr;
PImage up;
...
void setup() {
  ...
  initState = loadImage("char_front_still.png");
  downl = loadImage("char_front_l.png");
  downr = loadImage("char_front_r.png");
  down = loadImage("char_front_still.png");
  upl = loadImage("char_back_l.png");
  upr = loadImage("char_back_r.png");
  up= loadImage("char_back_still.png");
  left = loadImage("char_new_left.png");
  right = loadImage("char_new_right.png");
  x_soldier = 100;
  y_soldier = height/2;
